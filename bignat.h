...
const WORD __S = sizeof(WORD);

#define BIGNATBUFSIZE(x) ((x+(__S-1))/__S)
...
//    int potmax;
  ...
  public:
    ...
    void divLarge(const struct bignat &u,const struct bignat &v,struct bignat &r,WORD vbuf[BIGNATBUFSIZE(32)+1]);
  public:
    ...
    void Div(const struct bignat &x,const struct bignat& y,struct bignat &r,WORD vbuf[BIGNATBUFSIZE(32)+1]);
